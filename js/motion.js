/* PNW-FILE-GUIDE
   js/motion.js — window.PNWMotion, token durasi/easing animasi.
   Butuh GSAP (js/gsap/). Dipakai oleh js/app.js.
 */
  ...
  var API = {
    ...
    revealLines: function (scope) {
      ...
      var els = Array.prototype.slice.call(
        scope.querySelectorAll(".section, .line"),
      );
      try {
        if (!els.length) {
          G.fromTo(
        ...
        if (els.length > n)
          G.set(els.slice(n), { clearProps: "opacity,transform" });
      } catch (e) {}
    },
